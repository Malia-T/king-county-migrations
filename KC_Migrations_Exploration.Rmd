...
median_housing_2011_2020 <- inner_join(med_h_2011_2015, med_h_2016_2020, by = "CBSAA") %>% 
  ...
  select(-c(GISJOIN.x, GISJOIN.y, YEAR.x, YEAR.y))
...
flows_housing <- inner_join(sea_flows_2020, median_housing_2011_2020, by = c("FULL2_NAME" = "NAME_E.x"))

data <- flows_housing %>% 
  inner_join(race_2010_2020, by = c("FULL2_NAME" = "CBSA"))

write.csv(data, file = 'flows_race_housing.csv')
