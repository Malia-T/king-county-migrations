...
##### Housing Data #####
med_housing <- read_nhgis("data/nhgis0004_csv/nhgis0004_ds243_2019_metdiv.csv")
...
race_1990_2020 <- race_ts %>% 
  select(c(GISJOIN, GEOGYEAR, CBSA, 
...
race_2000_2020 <- race_1990_2020 %>% 
  ...
  select(c(GISJOIN, CBSA, chg_white_2000_2010, chg_white_2010_2020, chg_black_2000_2010,
